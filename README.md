...
```
curl -L https://raw.githubusercontent.com/tmobile/jazz-installer/v%231.0/installscripts/terraforminstaller/rhel7Installer.sh -o rhel7Installer.sh && chmod +x rhel7Installer.sh && ./rhel7Installer.sh v#1.0&& cd ./jazz-installer/installscripts/wizard && ./run.py 
